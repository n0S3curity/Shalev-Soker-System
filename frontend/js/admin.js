...
window.Admin = (function () {
  ...
  function credentialsMessage() {
    return [
      ...
      '',
      'איך נכנסים:',
      '1. פתחו את הכתובת שלמעלה בדפדפן.',
      '2. הזינו את שם המשתמש והסיסמה החד-פעמית.',
      '3. בכניסה הראשונה תתבקשו לבחור סיסמה קבועה משלכם.',
      '4. לאחר מכן בחרו רשות מקומית — רק אז נפתח טופס הסקר.',
      '',
  ...
  async function copyCredentials() {
    ...
    UI.show(box, true);
    UI.selectText(box);
    UI.toast('הדפדפן חוסם את ההעתקה — הטקסט מסומן, העתיקו עם Ctrl+C', 'info');
  }
